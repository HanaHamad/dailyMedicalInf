...
import com.example.dailymedicalinf.databinding.FragmentDoctorProfileBinding
import com.google.firebase.firestore.ktx.toObject
import java.util.*

class DoctorProfileFragment : Fragment() , DatePickerDialog.OnDateSetListener{
    ...
    private fun getUserInfo() {
        const = Constans(requireActivity())
